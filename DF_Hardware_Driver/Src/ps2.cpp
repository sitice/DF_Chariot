...
void PS2_Init(void)
{
//	GPIO_InitTypeDef  GPIO_InitStructure;  //D0 CS CLK
//	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);//使能GPIOB时钟
//	GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_10|GPIO_Pin_12|GPIO_Pin_11;// 对应IO口
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
//	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
//	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
//	GPIO_Init(GPIOD, &GPIO_InitStructure);//初始化GPIO
//	GPIO_SetBits(GPIOD,GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3);//GPIOA1 2 3设置高，灯灭

//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9; //对应引脚  DI
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;//普通输入模式
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100M
//	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
//	GPIO_Init(GPIOD, &GPIO_InitStructure);//初始化GPIOC2
...
float PS2_LX,PS2_LY,PS2_RX,PS2_RY;     //
int PS2_KEY;
//读取手柄信息
